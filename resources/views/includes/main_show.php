...
<main class="main_secciones">
    <form class="formulario" action='/usuario/<?php echo $_SESSION["id"] ?>' method="post">
        ...
        <input type="text" name="apellido" value="<?php echo $usuario["apellidos"]; ?>">
        <br><br>

        <label for="user">Nombre de usuario:</label>
        <input type="text" name="user" value="<?php echo $usuario["nombre_usuario"]; ?>">
        <br><br>
        ...
        <input type="number" name="saldo" value="<?php echo $usuario["saldo"]; ?>">
        <br><br>
